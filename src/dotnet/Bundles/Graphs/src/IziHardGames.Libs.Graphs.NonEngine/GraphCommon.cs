...
namespace IziHardGames.Libs.NonEngine.Graphs.RefType
{
    ...
    public class Graph
    {
        IPoolRent<GraphEdge> renterOfGraphEdge;
        IPoolRent<GraphNode> renterOfGraphNode;
        IPoolRent<GraphConnection> renterOfGraphConnection;
                                                         ...
                                                         IPoolRent<GraphConnection> renterOfGraphConnection)
        {
            ...
            renterOfGraphEdge.Rent();

            for (int i = 0; i < dataGraph.nodes.Length; i++)
            {
                GraphNode graphNode = renterOfGraphNode.Rent();
            ...
            {
                GraphEdge graphEdge = renterOfGraphEdge.Rent();
            ...
            {
                GraphConnection graphConnection = renterOfGraphConnection.Rent();
